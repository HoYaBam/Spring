...
public class MailController {
    ...
    public void sendSimpleMail(HttpServletRequest request, HttpServletResponse response) 
        ...
        sb.append("<meta http-equiv='Content-Type' content='text/html; charset=euc-kr'>");
 		...
 		sb.append("<img  src='https://avatars.githubusercontent.com/u/101304086?v=4' /> </a><br>");
 		sb.append("</a>");
 		sb.append("<a href='https://github.com/HoYaBam'>상품보기</a>");
 		sb.append("</body></html>");
 		String str=sb.toString();
 		mailService.sendMail("수신자이메일","신상품을 소개합니다.",str);
        out.print("메일을 보냈습니다!!");
    }
}